            ...
            <ul class="pagination">
                ...
                @if ($paginator->onFirstPage())
                    <li class="page-item disabled" aria-disabled="true">
                        <span class="page-link my-text-main">@lang('pagination.previous')</span>
                    </li>
                @else
                    <li class="page-item">
                        <a class="page-link text-white my-bg-acc" href="{{ $paginator->previousPageUrl() }}" rel="prev">@lang('pagination.previous')</a>
                    </li>
                @endif
                ...
                @if ($paginator->hasMorePages())
                    <li class="page-item">
                        <a class="page-link text-white my-bg-acc" href="{{ $paginator->nextPageUrl() }}" rel="next">@lang('pagination.next')</a>
                    </li>
                @else
                    <li class="page-item disabled" aria-disabled="true">
                        <span class="page-link my-text-main">@lang('pagination.next')</span>
                    </li>
                @endif
            </ul>
        </div>
