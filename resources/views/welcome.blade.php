    ...
    <div class="wrapper container-fluid">
        ...
        <div class="row justify-content-center">
            @forelse ($articles as $article)
                <div class="col-11 articles-home align-content-center rounded-3" data-aos="fade-right">
                    <div class="row">
                        ...
                        <div class="col-4 align-content-center ms-auto me-5 preview-last-articles">
                            ...
                            <a href="{{ route('detailArticle', compact('article')) }}" class="btn my-bg-quar btn-info-custom">Maggiori
                                Informazioni</a>
