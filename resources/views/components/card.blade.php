  ...
  <div class="col-12 card card-custom">
    <div class="row">
      <div class="col-4 py-0 ps-1 pe-0 ps-md-0 align-items-center d-flex col-md-12 hover-overlay card-header rounded" data-mdb-ripple-color="light">
        <img src="{{$article->images->isNotEmpty() ? $article->images->first()->getUrl(300, 300) : 'https://picsum.photos/300'}}" class="img-fluid rounded-1" alt="Immagine dell'articolo {{$article->title}}"/>
      </div>
