                    ...
                    <div class="row ">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="mb-3 container-custom">
                                <input type="text" placeholder="Titolo" class="form-control input-custom w-100 py-2" id="title" wire:model.blur="title">
                                @error('title')
                                <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="mb-3 container-custom">
                                <input type="text" class="form-control input-custom w-100 py-2" placeholder="Prezzo" id="price" wire:model.blur="price">
                                @error('price')
                                <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="mb-3 container-custom">
                                <textarea class="form-control input-custom w-100" placeholder="Descrizione" cols="30" rows="10" id="description" wire:model.blur="description"></textarea>
                                @error('description')
                                <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
